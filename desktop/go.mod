module github.com/jitheshsisodiya/Ed-s/desktop

go 1.25.0

// The desktop app drives the same tunnel engine as the CLI, so the GUI and
// nexusvpnctl can never diverge in connectivity behaviour.
