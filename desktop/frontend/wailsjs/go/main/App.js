...
export function AdoptThisMachine() {
  return window['go']['main']['App']['AdoptThisMachine']();
}

export function ClaimPairing(arg1) {
  return window['go']['main']['App']['ClaimPairing'](arg1);
}
